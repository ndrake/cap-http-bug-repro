  ...
  class extends HTMLElement {
    ...
    <div>
      ...
      <main>
        ...
        <p>
          <div id="data-div">data will go here...</div>
        </p>
    ...
    connectedCallback() {
      ...
      self.shadowRoot.querySelector('#get-data').addEventListener('click', async function (e) {
        try {
          ...
          const dataDiv = self.shadowRoot.querySelector('#data-div');
          dataDiv.innerHTML = "";
          dataDiv.appendChild(document.createTextNode(`Name: ${response.data.data['employee_name']}`));
        } catch(e) {
          console.log('ERROR fetching data', e);
          const dataDiv = self.shadowRoot.querySelector('#data-div');
          dataDiv.innerHTML = "";
          dataDiv.appendChild(document.createTextNode(`${e.message}`));
        }
      });
    }
  }
